                        ...
                        <div class="flex flex-row h-full">
                            ...
                            <div class="w-2/5 flex flex-col min-h-full p-4 bg-dark/10 border-s-2 border-dark border-dashed">
                                ...
                                <div class="w-full flex flex-col gap-y-2 items-end">
                                    <div class="py-2 px-4 bg-orange border-2 border-black text-xl font-bold rounded-full w-fit active:scale-95 duration-50 cursor-pointer" wire:navigate="">
                                        Pesan Tiket
                                    </div>
                                    <p class="font-italic text-sm text-right">*Peraturan, Kebijakan serta Syarat dan Ketentuan Berlaku</p>
                                </div>                             
                            </div>                             
                        </div>
                    </div>
